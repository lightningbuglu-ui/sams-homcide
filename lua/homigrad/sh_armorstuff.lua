...
-- Upper (shoulder/upper chest) armor slot
hg.armor.upper = {
	["gordon_upper"] = {
		"upper",
		"",
...
-- Knee armor slot (single entry that covers knees)
hg.armor.knee = {
	["gordon_knee"] = {
		"knee",
		"",
