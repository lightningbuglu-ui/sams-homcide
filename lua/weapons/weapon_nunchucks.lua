...
SWEP.WorldModel = "models/weapons/tfre/w_nunchucks.mdl"
SWEP.WorldModelReal = "models/weapons/tfre/c_nunchucks.mdl"
SWEP.ViewModel = "models/weapons/tfre/w_nunchucks.mdl"
