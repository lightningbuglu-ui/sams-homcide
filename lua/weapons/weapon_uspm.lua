...
SWEP.WepSelectIcon2 = Material("entities/uspm.png")
SWEP.IconOverride = "entities/uspm.png"
SWEP.WepSelectIcon2box = true
SWEP.FakeBodyGroups = "020121"
...
SWEP.LocalMuzzlePos = Vector(-2,0,6.5)
...
SWEP.Primary.Sound = {"weapons/arccw_uc_usp/fire-9-0"..math.random(1,6)..".ogg", 75, 90, 100}
SWEP.SupressedSound = {"weapons/arccw_uc_usp/fire-9-sup-0"..math.random(1,6)..".ogg", 65, 90, 100}
SWEP.DistSound = "weapons/arccw_uc_usp/fire-9-dist-0"..math.random(1,6)..".ogg"
SWEP.Primary.SoundEmpty = {"weapons/arccw_uc_usp/dryfire.wav", 75, 100, 105, CHAN_WEAPON, 2}
...
local function HideMag2(model, unhide)
	...
	model:ManipulateBoneScale(61, vec)
end
...
SWEP.AnimsEvents = {
	["reload_empty"] = {
		[0.2] = function(self)
			...
			ent:ManipulateBoneScale(60, Vector(1,1,1))
			ent:ManipulateBoneScale(61, Vector(1,1,1))
...
SWEP.ZoomPos = Vector(25, -0.05, 7.4)
