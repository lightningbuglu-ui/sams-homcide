...
SWEP.PrintName = "Bushmaster XM-15 e2s"
SWEP.Author = "Bushmaster"
SWEP.Instructions = "Civilian semi-automatic rifle based on M16A2. Short version. Chambered in 5.56x45 mm"
SWEP.Category = "Weapons - By `Зомби Чипсы`"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
...
SWEP.FakeBodyGroups = "00901427000"
