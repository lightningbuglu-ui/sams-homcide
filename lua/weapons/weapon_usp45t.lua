...
SWEP.PrintName = "USP-45 Tactical"
...
SWEP.WepSelectIcon2 = Material("entities/usp45t.png")
SWEP.IconOverride = "entities/usp45t.png"
...
SWEP.Primary.Sound = {"weapons/arccw_uc_usp/fire-0"..math.random(1,6)..".ogg", 75, 90, 100}
SWEP.SupressedSound = {"weapons/arccw_uc_usp/fire-sup-0"..math.random(1,6)..".ogg", 65, 90, 100}
SWEP.DistSound = "weapons/arccw_uc_usp/fire-dist-0"..math.random(1,6)..".ogg"
